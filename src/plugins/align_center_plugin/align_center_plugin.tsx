...
export function Icon({ onClick }: { onClick: (option: string) => void }) {
	...
	return (
		<div
			...
			onClick={handleClick}
		>
			<img width="24" height="24" src="https://img.icons8.com/ios-glyphs/30/align-center.png" alt="align-center" />
		</div>
	);
}


const alignCenterPlugin: EditorPlugin = {
	applyFormat(before, selected, after, value) {
		return before+`<p style="text-align: center;">${selected}</p>`+after;
	},
};
